...
stats "../data/cases_jena_opendata.csv" u 2 prefix "A" nooutput

# gets maximum number of recovered people
stats "../data/cases_jena_opendata.csv" u 3 prefix "B" nooutput

# gets maximum number of dead people
stats "../data/cases_jena_opendata.csv" u 4 prefix "C" nooutput
...
plot \
     ...
     "<echo 0" u (xpos):(ypos(2)) w p pt 5 ps 4 lc rgb "#133370", \
     ...
     "<echo 0" u (xpos):(ypos(3)) w p pt 5 ps 4 lc rgb "#5B8F22", \
